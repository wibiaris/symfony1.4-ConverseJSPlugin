 ...
 * Dual licensed under the MIT and GPL Licensesfrosterview
 */
...
(function (root, factory) {
    ...
    converse.initialize = function (settings) {
        ...
        this.bosh_service_url = 'http://localhost:5280/http-bind'; // The BOSH connection manager URL. Required if you are not prebinding.
        ...
        this.RosterView = Backbone.View.extend({
            ...
            template: _.template('<dt id="xmpp-contact-requests">'+__('Contact requests')+'</dt>' +
                                '<dt id="xmpp-contacts">'+__('Daftar Teman')+'</dt>' +
